...
const FlowerShape = ({ track }: { track: Track }): JSX.Element => {
    ...
    return (
        <>
            ...
            C227.5,160.4,229,160.5,230.5,160.5z M130.5,195.5c-35.9,0-65-29.1-65-65s29.1-65,65-65s65,29.1,65,65S166.4,195.5,130.5,195.5z"/>
            <circle fill={theme.secondary} cx="130.5" cy="130.5" r="40" />
        </>
...
// 	c11.7,11.7,30.7,11.7,42.4,0c11.7-11.7,11.7-30.7,0-42.4c-1.1-1.1-2.2-2.1-3.4-2.9c2.8-5.4,5.2-11,7-16.9
// 	C227.5,160.4,229,160.5,230.5,160.5z M130.5,195.5c-35.9,0-65-29.1-65-65s29.1-65,65-65s65,29.1,65,65S166.4,195.5,130.5,195.5z"/>
// <circle class="st0" cx="130.5" cy="130.5" r="40"/>
// </svg>
